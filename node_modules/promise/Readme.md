...
You can enable bookShop of unhandled ReferenceErrors and TypeErrors via:
...
You can enable bookShop of all unhandled rejections if you need to debug an exception you think is being swallowed by promises:
